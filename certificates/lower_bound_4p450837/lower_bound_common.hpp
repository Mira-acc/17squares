...
// The claimed lower-bound side length is L = 4450837/1000000.
// Center coordinates are represented on the exact grid SX = 1000000*2^40.
// Slope t = tan(theta), with -1 <= t <= 1, is represented on ST = 2^40.
// Point coordinates have denominator PD = 10^6.
constexpr std::int64_t ST = (std::int64_t{1} << 40);
constexpr std::int64_t SX = 1000000 * ST;
constexpr std::int64_t L_SCALED = 4450837 * ST;
constexpr std::int64_t CENTER_LO = 500000 * ST;
constexpr std::int64_t CENTER_HI = 3950837 * ST;
