...
computer-assisted certificate proving $s(17)>4.607028598640$. A nonnegative
rational measure on 1,200 points has total mass $16.98264408<17$, yet assigns
...
Let
\[
 L=\frac{4607}{1000},\quad B=\frac{19997}{20000},\quad
 h=\frac{207107}{1440000000}.
\]
Then
\[
 s(17)\ge S_*:=\frac{L\sqrt{1+h^2}}{B(1+h)}
 =\sqrt{\frac{17604407342714743536607440400}{829429719507765981945905041}}
 >4.607028598640.
\]
\end{theorem}
The base certificate excludes a packing at side $4.607$. The endpoint
$S_*=4.607028598640215\ldots$ follows by dilation; exclusion at that endpoint
...
\[
 4.607028598640<s(17)\le4.67553009360455\ldots.
\]
...
The contribution here is the stronger rational certificate and its exact
arithmetic replay. The derived data retain eight symmetry images of Mira's
earlier point $(1.494140,2.660211)$, scaled from side $4.450837$ to $4.607$.
Their total weight is $0.03438968$. Removing that orbit reduces the
axis-aligned core minimum to $0.99140418$, invalidating this certificate;
this does not preclude reoptimization without the orbit.
...
The exact rational comparison $(4.607028598640)^2<S_*^2$ proves the strict
...
Atoms & 1,200\\
Directions & 2,881\\
Total mass & $212283051/12500000=16.98264408$\\
Minimum closed-core mass & $25000029/25000000=1.00000116$\\
Centre slabs & 6,679,269\\
\bottomrule
\end{tabular}
\end{center}
The authoritative atoms are in
\path{certificates/lower_bound_4p607/best-certificate.json}, with SHA-256
\begin{center}\small\ttfamily
8d824dedaa00d6f49fb13198e2fcbfd2a9781e4847a39411cf178555ca4ebe3d.
\end{center}
From the repository root, run
\begin{quote}\ttfamily\small
python3 certificates/lower\_bound\_4p607/verify.py --direct
\end{quote}
...
the result ledger and endpoint. Python's standard library, C++17 and Boost
headers suffice. The command \texttt{bash ./verify\_all.sh} additionally
regenerates and checks the historical triangle-witness certificate.
